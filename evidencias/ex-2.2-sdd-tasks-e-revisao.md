...
Segui o fluxo Spec-Driven Development em três etapas, sem pular nenhuma:
...
O protótipo que construí no Exercício 1.3 (Python + ChromaDB + sentence-transformers) serviu como validação prática antes de qualquer código de produção. Na prática, três aprendizados do protótipo influenciaram diretamente este cenário:
