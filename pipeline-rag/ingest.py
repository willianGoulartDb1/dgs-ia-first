"""
Pipeline de ingestão de documentos NovaTech em ChromaDB.
Embeddings multilíngues via sentence-transformers (gratuito, sem API).
Autor: Willian Goulart — Exercício 1.3, Trilha AI First DGS
"""
